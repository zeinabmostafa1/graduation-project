...
<div class="products" id="products">
    <h1 class="special-heading"> <?php echo $schools['name'] ;?> المجموعة</h1>
<!-- start Product -->
<div class="section-1">
    <div class="container">
        <?php while ($packages = mysqli_fetch_assoc($result1)) { ?>
            <div class="box">
                ...
                <div class="content">
                    ...
                    <p>السعر: <?php echo $packages['price']; ?></p>
                </div>
                <div class="info">
                    <a href="view-pack.php?id=<?php echo $packages['id'];?>">عرض المجموعة </a>
