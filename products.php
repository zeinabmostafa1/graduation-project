...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    if (!empty($search)) {
        $sql = "SELECT * FROM `products` WHERE `name` LIKE '%$search%' ORDER BY 
        RAND() 
    ...
    <div class="section-1">
        <div class="container">
            <?php while ($product = mysqli_fetch_assoc($result1)) { ?>
                <div class="box">
                    <img src="uploads/<?php echo $product['IMG']; ?>" alt="" width="200" height="200">
                    <div class="content">
                        <h3><?php echo $product['name']; ?></h3>
                        <p>Price: <?php echo $product['price']; ?></p>
                    </div>
                    <div class="info">
                        <a href="show-product.php?id=<?php echo $product['id'];?>" style="text-decoration: none;">Show Product</a>
